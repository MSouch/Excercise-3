...
const ExerciseForm=({exercise,onComplete})=> {
  ...
  useEffect(()=> {
    // Auto-save every 30 seconds only while actively completing the form (before completion)
    if (completed || showModelAnswer) return
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      >
        ...
        <div className="p-6">
          {saved && !completed && !showModelAnswer && (
            <motion.div
