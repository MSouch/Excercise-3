...
export const useProgress = () => {
  ...
  const loadProgress = () => {
    try {
      ...
      const stored = localStorage.getItem('communicationProgress')
      if (stored) {
        ...
        localStorage.setItem('communicationProgress', JSON.stringify(defaultProgress))
      }
    } catch (error) {
  ...
  const saveProgress = (progressData) => {
    try {
      ...
      localStorage.setItem('communicationProgress', JSON.stringify(progressData))
      setProgress(progressData)
    } catch (error) {
  ...
  console.log('useProgress: Returning progress state:', { progress, loading, completedChallenges: progress.completedChallenges })
