...
import medallionImage from '../assets/APLS-Medallion-2025_Communication.png'
...
const SIMULATION_CONFIG = {
  // Simulation Identity
  name: 'Communication Navigator',
  credentialTitle: 'Certified Cross-Functional Communication Professional',
  programName: 'Communication Navigator Program',
  completionCode: 'CN0300',
  ...
  performanceImpacts: [
    { 
      ...
      impact: 'Prevented communication breakdown during emergency shutdown affecting 6 departments' 
    },
    { 
      challenge: 'Challenge 2', 
      impact: 'Resolved resource conflicts between 3 critical projects through stakeholder analysis' 
    },
    { 
      challenge: 'Challenge 3', 
      impact: 'Translated complex technical requirements into actionable plans for all departments' 
    },
    { 
      challenge: 'Challenge 4', 
      impact: 'Designed comprehensive change management strategy for plant-wide digital transformation' 
    }
  ],
  
  // Real-World Success Statistics (4 metrics)
  successStatistics: {
    intro: 'Organizations that implement systematic cross-functional communication practices like yours see:',
    metrics: [
      { 
        metric: '23%', 
        label: 'Decrease in schedule delays', 
        direction: 'down'
      },
      { 
        metric: '31%', 
        label: 'Decrease in stakeholder escalations', 
        direction: 'down' 
      },
      { 
        metric: '27%', 
        label: 'Decrease in communication rework', 
        direction: 'down' 
      },
      { 
        metric: '18%', 
        label: 'Increase in cross-team satisfaction', 
        direction: 'up' 
      }
    ],
    ...
    overallSuccess: [
      { 
        ...
        label: 'Improved cross-functional coordination' 
      },
      { 
        metric: 'Higher Quality', 
        label: 'Better stakeholder alignment outcomes' 
      },
      { 
        metric: 'Stronger Relationships', 
        label: 'Enhanced collaborative problem-solving' 
      }
    ]
  },
  ...
  nextSteps: {
    immediateActions: [
      'Apply these frameworks in your daily cross-functional communication activities',
      'Share knowledge with colleagues facing similar challenges',
      'Document lessons learned from each communication experience',
      'Build relationships proactively with key stakeholders across departments'
    ],
    continueLinks: [
      { text: 'Advanced Stakeholder Management Workshop', href: '#' },
      { text: 'Cross-Functional Leadership Excellence Course', href: '#' },
      { text: 'Strategic Communication Planning Program', href: '#' },
...
const Conclusion = () => {
  ...
  useEffect(() => {
    ...
    if (completed === total && !credentialId) {
      const stored = localStorage.getItem('communicationCredential')
      if (stored) {
        try {
      ...
      try {
        localStorage.setItem('communicationCredential', JSON.stringify(payload))
      } catch (e) {
